 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Scuadra) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Scuadra server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Scuadra server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "connect.connected_to_cloud": "Connected to Scuadra Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Scuadra agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Scuadra agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Scuadra agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Scuadra agent resolution",
  "connect.diagnostics_check_cloud_tool_catalog": "Scuadra Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global Scuadra Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Scuadra-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single Scuadra Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_openwork_client": "Scuadra client",
  "connect.diagnostics_owner_openwork_server": "Scuadra server",
  "connect.diagnostics_owner_openwork_support": "Scuadra support",
  ...
  "connect.diagnostics_configured_agent": "Configured Scuadra agent",
  "connect.diagnostics_effective_agent": "Effective Scuadra agent",
  "connect.diagnostics_agent_state": "Scuadra agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote Scuadra workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace Scuadra Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Scuadra Den.",
  ...
  "connect.pitch_title": "Connect is the new way Scuadra lets you share workflows with your team.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Scuadra servers.",
  ...
  "config.server_needed_hint": "Scuadra server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Scuadra server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Scuadra server",
  ...
  "config.server_sharing_title": "Scuadra server sharing",
  "config.server_url_hint": "Use the URL shared by your Scuadra server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Scuadra server URL",
  "config.server_url_label": "Scuadra Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Scuadra server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Scuadra server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Scuadra server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Scuadra server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Scuadra server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Scuadra worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Scuadra worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an Scuadra server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Scuadra server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Scuadra worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Scuadra and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Scuadra will reconnect here automatically.",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access Scuadra Cloud.",
  "den.cloud_section_title": "Scuadra Cloud",
  "den.cloud_sleep_hint": "Sign in to Scuadra Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Scuadra Cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "Scuadra Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Scuadra Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid Scuadra sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Scuadra Cloud sign-in.",
  "den.error_signout_failed": "Could not sign out of Scuadra Cloud. Try again.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into Scuadra automatically, paste the sign-in link or one-time code from Scuadra Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Scuadra Cloud",
  "den.signing_in": "Finishing Scuadra Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect Scuadra.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Scuadra.",
  "den.status_cloud_signed_in_as": "Connected Scuadra Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Scuadra Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your Scuadra Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Scuadra is using the default Cloud control plane.",
  ...
  "extensions.marketplace_description": "Browse Scuadra built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through Scuadra Connect, while GitHub and Claude plugin imports live in local Extensions.",
  ...
  "mcp.toggle_requires_server": "Connect to an Scuadra server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Scuadra can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Scuadra needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Scuadra needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Scuadra",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Scuadra.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "Scuadra Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the Scuadra app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "Scuadra UI Control",
  ...
  "notifications.empty_hint": "Updates from Scuadra Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the Scuadra server",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Scuadra will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Scuadra server URL.",
  "welcome.organization_server_link": "Using Scuadra on-premises?",
  ...
  "welcome.use_cloud": "Use Scuadra Cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted Scuadra and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Scuadra will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Scuadra can pick them up.",
  ...
  "join_org.error_invalid": "That does not look like an Scuadra organization invite or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid Scuadra organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "Scuadra could not reach that organization server. Check your connection or VPN, then try again.",
  ...
  "join_org.openwork_cloud": "Scuadra Cloud",
  ...
  "session.share_local_host_not_ready": "Local Scuadra host is not ready yet.",
  "session.share_missing_host_url": "Missing Scuadra host URL.",
  "session.share_missing_token": "Missing Scuadra token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for Scuadra workers.",
  ...
  "settings.privacy_section_desc": "Control what Scuadra shares to improve the product.",
  ...
  "settings.capabilities_title": "Scuadra server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Scuadra at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "Scuadra server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "Scuadra writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No Scuadra-managed keys removed.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Scuadra events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Scuadra. Off by default.",
  ...
  "settings.feedback_title": "Help shape Scuadra",
  ...
  "settings.nuke_confirmation_hint": "Scuadra will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local Scuadra, OpenCode, browser, token, runtime, cache, and orchestrator state on this device.",
  ...
  "settings.nuke_survives_app": "The installed Scuadra app and protocol registration stay installed.",
  ...
  "settings.open_deeplink_desc": "Paste an Scuadra deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard Scuadra Cloud.",
  "settings.organization_server_desc": "Point Scuadra at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Scuadra server URL. Saving signs you out so Scuadra can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Scuadra.",
  ...
  "settings.openwork_config_sidecar_desc": "Local Scuadra server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "Scuadra server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "Scuadra server",
  ...
  "settings.quit_hint": "Scuadra quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Scuadra server.",
  "settings.reconnected": "Reconnected to Scuadra server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Scuadra cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Scuadra cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Scuadra will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Scuadra preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Scuadra local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset Scuadra + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Scuadra will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openwork_server": "Restart Scuadra server",
  ...
  "settings.services_section_desc": "Local services that power this Scuadra session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Scuadra.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Scuadra will use after local overrides and bootstrap files are applied.",
  ...
  "settings.runtime_desc": "Status for your local engine and Scuadra server.",
  ...
  "settings.tab_connect": "Scuadra Connect",
  ...
  "settings.tab_description_appearance": "Adjust how Scuadra looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Scuadra workspace plus its runtime connection.",
  ...
  "settings.environment.override_hint": "Environment variables set before Scuadra starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Scuadra will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Scuadra is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Scuadra status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by Scuadra/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your Scuadra account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Scuadra {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Scuadra and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Scuadra now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Scuadra up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an Scuadra host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Scuadra server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Scuadra Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Scuadra Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Scuadra Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Scuadra features",
  ...
  "status.openwork_ready": "Scuadra Ready",
  ...
  "system.reload_body_default": "Scuadra detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Scuadra detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Scuadra can't load tasks from this worker until the connection is fixed.",
